...
Before you can run any Radio on Graphcast, you need to register a Graphcast ID for your on-chain Indexer address. You can learn what a Graphcast ID is and how to register one [here](http://https://docs.graphops.xyz/graphcast/sdk/registry#register-a-graphcast-id).
